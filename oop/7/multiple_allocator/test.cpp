...
#include "myallocator_2.h"
#include "myallocator_1.h"
#include "norallocator.h"
...
int main()
{
    ...
    cout << "----------baseallocator without memory pool-----------" << endl;

    // Test with norallocator
    ...
    cout << "-------------myallocator_2 with memory pool-------------" << endl;

    // Test with myallocator_2
    start = chrono::system_clock::now();
    test<myallocator_2>();
    end = chrono::system_clock::now();
    duration = chrono::duration_cast<chrono::microseconds>(end - start);
